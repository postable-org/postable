      ...
      <div className="max-w-5xl w-full">
        <div className="text-center mb-10">
          ...
          <p
            ...
            style={{ color: '#6b6760', fontFamily: 'var(--font-body)' }}
          >
            Posts gerados por IA, por plataforma, todo mês.
          </p>

          {/* Billing toggle */}
          <div className="inline-flex items-center rounded-full p-1" style={{ backgroundColor: '#e4e0d8' }}>
            <button
              onClick={() => setBilling('monthly')}
              className="px-5 py-1.5 rounded-full text-sm font-medium transition-all"
              style={{
                backgroundColor: billing === 'monthly' ? '#0a0a0a' : 'transparent',
                color: billing === 'monthly' ? '#f8f5ef' : '#6b6760',
            ...
            <button
              ...
              style={{
                backgroundColor: billing === 'yearly' ? '#0a0a0a' : 'transparent',
                color: billing === 'yearly' ? '#f8f5ef' : '#6b6760',
                fontFamily: 'var(--font-body)',
              }}
            >
              Anual
              <span
                ...
                style={{
                  backgroundColor: billing === 'yearly' ? 'rgba(166,200,249,0.25)' : '#d4f0d4',
        ...
        {error && (
          <div
            className="mb-8 text-center text-sm px-4 py-3 rounded-xl"
            style={{ backgroundColor: '#fce8e8', color: '#c0392b' }}
          >
            {error}
          </div>
        )}
              ...
              >
                <div className="mb-6">
                  <span
                    ...
                    style={{ color: plan.highlight ? 'rgba(248,245,239,0.5)' : '#a09d98' }}
                  >
                    {plan.name}
                  </span>
                  ...
                  {billing === 'yearly' && (
                    <p
                      ...
                      style={{ color: plan.highlight ? 'rgba(166,200,249,0.7)' : '#6b9e6b' }}
                    >
                      Cobrado anualmente
                    </p>
                  )}
                  <p
                    ...
                    style={{ color: plan.highlight ? 'rgba(248,245,239,0.6)' : '#6b6760' }}
                  >
                    {plan.description}
                  </p>
                </div>
                ...
                <ul className="space-y-3 mb-8 flex-1">
                  <li className="flex items-center gap-2.5 text-sm">
                    <Check
                      size={14}
                      strokeWidth={2.5}
                      style={{ color: plan.highlight ? '#a6c8f9' : '#22c55e', flexShrink: 0 }}
                    />
                  ...
                  <li className="flex items-center gap-2.5 text-sm">
                    {plan.analyticsEnabled ? (
                      ...
                      <X
                        size={14}
                        strokeWidth={2.5}
                        style={{ color: plan.highlight ? 'rgba(248,245,239,0.3)' : '#d1cfc9', flexShrink: 0 }}
                      />
                    )}
                    <span
                      style={{
                ...
                <button
                  ...
                  className="w-full py-2.5 rounded-full text-sm font-semibold transition-all active:scale-[0.97] disabled:opacity-60"
                  style={{

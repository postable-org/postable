 ...
 * then send the user to /dashboard (which will redirect to /brand-setup if they
...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.redirect(`${origin}/login?error=auth_error&error_description=Falha+na+confirmacao+de+email`);
}
